...
* [Running Open WebUI](#running-open-webui-along-with-launching-llama.cpp-and-ppen-webui-server)
* [Reference](#reference)
...
## Running Open WebUI along with launching llama.cpp and Open WebUI server
